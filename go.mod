...
require (
	...
	github.com/mike76-dev/renterd-satellite v0.0.0-20230420081439-3b27093321dc
...
require (
	...
	github.com/mike76-dev/sia-web v0.0.0-20230421120922-a8e3ce5a0f08 // indirect
	github.com/mike76-dev/sia-web/renterd v0.1.0 // indirect
